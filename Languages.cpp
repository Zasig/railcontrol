...
/* TextApiServerStarted */ { "API server started", "API-Server wurde gestartet", "Servidor API encendido" },
/* TextApiServerStopped */ { "API server stopped", "API-Server wurde gestoppt", "Servidor API apagado" },
...
/* TextConditions */ { "Conditions", "Bedingungen", "Condiciones" },
/* TextConditionsNotFulfilled */ { "Conditions for route not fulfilled", "Bedingungen der Fahrstrasse nicht erfüllt", "Condiciones del itinerario no cumplidas" },
/* TextConfigFileNotFound */ { "Config file {0} not found. Using default config file {1}.", "Konfigurationsdatei {0} nicht gefunden. Verwende Vorlage {1}.", "Archivo de configuración {0} no encontrado. Se utilizará el archivo de configuración predeterminado {1}." },
...
/* TextControlChecker */ { "Control Checker", "Zentralenchecker", "Verificador de control" },
/* TextControlCheckerThreadStarted */ { "ControlChecker thread started", "Zentralencheckerthread gestartet", "Verificador de control thread encendido" },
/* TextControlCheckerThreadTerminated */ { "Control Checker thread terminated", "Zentralencheckerthread beendet", "Verificador de control thread apagado" },
...
/* TextDevice */ { "Device", "Gerät", "Dispositivo" },
...
/* TextFeedbacksOfControl */ {"​Feedbacks of {0}", "​Rückmelder von {0}", "​Retroseñales de {0}" },
/* TextFeedbacksOfControlDeviceBus */ {"​Feedbacks of {0} device {1} bus {2}", "​Rückmelder von {0} Gerät {1} Bus {2}", "​Retroseñales de {0} dispositivo {1} bus {2}" },
...
/* TextModule */ { "Module", "Modul", "Módulo" },
...
/* TextOccupied */ { "occupied", "besetzt", "ocupado" },
...
/* TextRouteReserved */ { "Route {0} reserved", "Fahrstrasse {0} reserviert", "Itinerario {0} reservado" },
...
/* TextSaveDatabase */ { "Save database", "Datenbank speichern", "Guardar base de datos" },
/* TextDatabaseSaved */ { "Database saved", "Datenbank gespeichert", "Base de datos guardada" },
...
/* TextTryingToReserveRoute */ { "Trying to reserve route {0}", "Versuche die Fahrstrasse {0} zu reservieren", "Intentanto reservar itinerario {0}" },
...
/* TextUnableToFindDestinationTrack */ { "Unable to find destination track", "Nicht möglich das Zielgleis zu finden", "Imposible encontrar vía de destino" },
...
/* TextUnableToReserveRoute */ { "Uable to reserve route {0}", "Nicht möglich die Fahrstrasse {0} zu reservieren", "Imposible reservar itinerario {0}" },
...
/* TextUnableToSetDestinationOrientation */ { "Unable to set orientation of destination track {0}", "Nicht möglich die Fahrtrichtung des Zielgeises {0} zu setzen", "Imposible cambiar el sentido de la marcha de la vía de destino {0}" },
